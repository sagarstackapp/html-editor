...
import 'package:html_editor_demo/html_editor/local_server.dart';
import 'package:html_editor_demo/html_editor/pick_image.dart';
...
class HtmlEditorState extends State<HtmlEditor> {
  ...
  _loadHtmlFromAssets() async {
    const filePath = 'summernote/summernote.html';
          ...
          Expanded(
            child: WebView(
              ...
              onWebViewCreated: (webViewController) {
                ...
                if (Platform.isAndroid) {
                  const filename = 'summernote/summernote.html';
                  _controller!.loadUrl(
